...
const LoginModal: React.FC<LoginModalProps> = ({
  ...
  const modal = (
    ...
    >
      ...
      {/* Panel */}
      <div
        className="relative w-full sm:max-w-[420px] bg-neon-panel rounded-t-3xl sm:rounded-2xl overflow-hidden shadow-2xl shadow-neon-violet/15 border border-white/[0.08] flex flex-col"
      ...
      >
        ...
        <button
          onClick={handleClose}
          className="absolute top-4 right-4 z-10 w-9 h-9 flex items-center justify-center rounded-full bg-white/10 hover:bg-white/20 text-white transition"
          aria-label="Close"
        >
        ...
        {view === 'form' && (
          <button
            ...
            className="absolute top-4 left-4 z-10 w-9 h-9 flex items-center justify-center rounded-full bg-white/10 hover:bg-white/20 text-white transition"
            aria-label="Back"
          >
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        {/* Scrollable content */}
        <div className="overflow-y-auto flex-1 px-6 pt-10 pb-4">
          {/* Title */}
        ...
        {/* ── Terms footer ── */}
        <div className="border-t border-white/10 bg-white/5 px-6 py-4 text-center space-y-3">
...
const OptionButton: React.FC<{
  ...
  <button
    type="button"
    onClick={onClick}
    className="w-full flex items-center gap-4 px-5 py-3.5 bg-neon-elevated hover:bg-neon-ink border border-white/10 rounded-xl text-white font-semibold text-sm transition text-left"
  >
