...
const LoginModal: React.FC<LoginModalProps> = ({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (mode === 'login') {
        ...
        // Show interest selector before completing signup flow
  ...
  // After signup — show the interest selector fullscreen before completing the flow
  if (showInterests) {
    return (
      <InterestSelector
        onComplete={() => {
  ...
  const modal = (
    ...
    >
      ...
      {/* Panel */}
      <div
        className="relative w-full sm:max-w-[420px] overflow-hidden rounded-t-3xl sm:rounded-2xl border border-cyan-400/25 bg-gradient-to-br from-[#151528]/95 via-[#11111f]/95 to-[#0b0b16]/95 shadow-[0_0_0_1px_rgba(157,77,255,0.16),0_18px_46px_rgba(0,0,0,0.72),0_0_44px_rgba(39,233,255,0.12)] flex flex-col"
      ...
      >
        ...
        <button
          onClick={handleClose}
          className="absolute top-4 right-4 z-10 w-9 h-9 flex items-center justify-center rounded-full border border-white/20 bg-white/10 hover:bg-white/20 text-white transition shadow-[0_0_18px_rgba(157,77,255,0.22)]"
          aria-label="Close"
        >
        ...
        {view === 'form' && (
          <button
            ...
            className="absolute top-4 left-4 z-10 w-9 h-9 flex items-center justify-center rounded-full border border-white/20 bg-white/10 hover:bg-white/20 text-white transition shadow-[0_0_18px_rgba(157,77,255,0.22)]"
            aria-label="Back"
          >
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        {/* Scrollable content */}
        <div className="relative z-[1] overflow-y-auto flex-1 px-6 pt-10 pb-4">
          {/* Title */}
          ...
          {view === 'options' ? (
            ...
            <div className="space-y-3">
              ...
              {mode === 'login' && (
                /* Apple — login only, matching TikTok */
                <OptionButton
                  icon={
        ...
        {/* ── Terms footer ── */}
        <div className="relative z-[1] border-t border-violet-300/20 bg-white/[0.04] px-6 py-4 text-center space-y-3">
          <p className="text-[11px] text-white/40 leading-relaxed">
            By continuing, you agree to our{' '}
            <span className="text-white/70 underline cursor-pointer">Terms of Service</span> and confirm that you have read our{' '}
...
const OptionButton: React.FC<{
  ...
  <button
    type="button"
    onClick={onClick}
    className="w-full flex items-center gap-4 px-5 py-3.5 bg-gradient-to-r from-[#1b1b2b] to-[#131324] hover:from-[#23233a] hover:to-[#17172b] border border-violet-300/25 rounded-xl text-white font-semibold text-sm transition text-left shadow-[0_0_0_1px_rgba(39,233,255,0.1)]"
  >
