...
const Notifications: React.FC<NotificationsProps> = ({ notifications, onClose }) => {
  return createPortal(
    <div className="fixed inset-0 z-[20000]">
      ...
      <div className="absolute top-20 right-4 w-[min(420px,calc(100vw-2rem))] bg-zinc-900 border border-zinc-800 rounded-2xl shadow-2xl overflow-hidden animate-in fade-in zoom-in duration-200">
